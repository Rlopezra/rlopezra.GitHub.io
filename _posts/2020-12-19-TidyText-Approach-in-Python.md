...
One of the most popular methods to analyze open-ended data is to categorize the responses with a code that encapsulate it. When categorizing open-ended responses, UX Researchers usually have a pre-determined list of codes or  add codes to a list as they categorize responses. Taking this approach to analyze open-ended responses is a simple and effective method when dealing with small sample sizes (less than 50 responses) and few open-ended questions.
