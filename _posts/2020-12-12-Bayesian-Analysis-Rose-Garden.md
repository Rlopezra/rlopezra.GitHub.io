...
![P(+) = P(+|D)\\cdot{}P(D) +
P(+|D^{c})\\cdot{}P(D^{c})](https://latex.codecogs.com/png.latex?P%28%2B%29%20%3D%20P%28%2B%7CD%29%5Ccdot%7B%7DP%28D%29%20%2B%20P%28%2B%7CD%5E%7Bc%7D%29%5Ccdot%7B%7DP%28D%5E%7Bc%7D%29
"P(+) = P(+|D)\\cdot{}P(D) + P(+|D^{c})\\cdot{}P(D^{c})")

![P(+)
= 0.91\\cdot{}0.004+ 0.05\\cdot{}0.996](https://latex.codecogs.com/png.latex?P%28%2B%29%20%3D%200.91%5Ccdot%7B%7D0.004%2B%200.05%5Ccdot%7B%7D0.996
"P(+) = 0.91\\cdot{}0.004+ 0.05\\cdot{}0.996")

![P(+)
= 0.05344](https://latex.codecogs.com/png.latex?P%28%2B%29%20%3D%200.05344
"P(+) = 0.05344")
...
P(+|D^{c})\\cdot{}P(D^{c})}](https://latex.codecogs.com/png.latex?P%28D%7C%2B%29%20%3D%20%5Cfrac%7BP%28%2B%7CD%29%5Ccdot%7B%7DP%28D%29%7D%7BP%28%2B%7CD%29%5Ccdot%7B%7DP%28D%29%2B%20P%28%2B%7CD%5E%7Bc%7D%29%5Ccdot%7B%7DP%28D%5E%7Bc%7D%29%7D
"P(D|+) = \\frac{P(+|D)\\cdot{}P(D)}{P(+|D)\\cdot{}P(D)+ P(+|D^{c})\\cdot{}P(D^{c})}")

![P(D|+) =
\\frac{0.91\\cdot{}0.004}{0.91\\cdot{}0.004+ 0.05\\cdot{}0.996}](https://latex.codecogs.com/png.latex?P%28D%7C%2B%29%20%3D%20%5Cfrac%7B0.91%5Ccdot%7B%7D0.004%7D%7B0.91%5Ccdot%7B%7D0.004%2B%200.05%5Ccdot%7B%7D0.996%7D
